...
cd /home/bmlt/public_html/wordpress
sudo -u bmlt wp core install --url=http://bmlt.bmlt/wordpress --title="BMLT Test" --admin_user=test --admin_password=test --admin_email=bmlt@bmlt.bmlt
