...
sed -i -- 's+Exec=/usr/bin/google-chrome-stable %U+Exec=/usr/bin/google-chrome-stable %U --make-default-browser --disable-metrics+g/n+Exec=/usr/bin/google-chrome-stable %U https://'$DOMAIN'g' /etc/xdg/autostart/google-chrome.desktop
#Reboots system
reboot
