...
sudo -u $DOMAINUSER wp core install --url=http://$DOMAIN/wordpress --title="BMLT Test" --admin_user=$WPADMIN --admin_password=$WPADMINPASS --admin_email=$DOMAINUSER@$DOMAIN
